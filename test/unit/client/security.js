var fs = require('fs');
var SecurityHandler = require('../../../lib/handlers/client/security/security.js').SecurityClientHandler;
...
module.exports = {
	...
	"usename token generated correctly": function (test) {
    	...
    	var s = new SecurityHandler({}, [new sec.UsernameToken({username: "yaron", password: "1234"})]);
        s.next = new Mock(test);
    	var ctx = {request: utils.EMPTY_SOAP, url: "http://someUrl"};
    	ctx.action = "MyAction";
    	s.send(ctx);  
